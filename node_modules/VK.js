...
var VK = {
    ...
    checkToken: function(_callback) {
        ...
        if (fileJSON && fileJSON.token && fileJSON.user_id) {
            ...
            var msg = "Вам нужно получить новый токен, пройдите по адресу\n" +
                "\033[32m http://vk.cc/3D4kX2 \033[0m \n"+
                "результат получившийся в адресной строке занесите сюда\n" +
                "и перезапустите программу\n>\n\n";
            // "https://oauth.vk.com/authorize?client_id=3270660&scope=notify,friends,status,messages,offline,photos&redirect_uri=https://oauth.vk.com/blank.html&display=page&v=5.21&response_type=token\n\n";

            setTimeout(function() {
                open('http://vk.cc/3D4kX2');
            }, 1000);
    ...
    //  ========
    // отправка запроса
    request: function(_method, _params, _callback, _err) {
